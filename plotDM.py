...
Range = np.linspace(0.3,0.5,N_plots)
#Range =[0.1]
...
for i in range(N_plots):
	...
	print ("\nFor "+str(varying_param)+" = "+str(Range[i * step])+", the best fidelity is "+str(float(int(round(Max_fidelity[i]*1000))/1000))+" for phi = "+str(float(int(phi[Max_index[i]]*100)/100)))
